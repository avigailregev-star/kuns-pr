...
describe('paymentStatusLabel', () => {
  ...
  test('maps Pending to לא שולם', () => {
    expect(paymentStatusLabel('Pending')).toBe('לא שולם');
  });
  ...
  test('falls back to לא שולם for null, undefined, or an unrecognized value', () => {
    expect(paymentStatusLabel(null)).toBe('לא שולם');
    expect(paymentStatusLabel(undefined)).toBe('לא שולם');
    expect(paymentStatusLabel('SomethingElse')).toBe('לא שולם');
  });
});
