...
describe('LESSON_TYPE_OPTIONS', () => {
  test('has exactly 20 options in the required order', () => {
...
describe('getLessonTypeValue', () => {
  ...
  test('maps the four new theory sub-types to "theory"', () => {
    ...
    expect(getLessonTypeValue('פיתוח שמיעה')).toBe('theory');
  });
...
describe('ENSEMBLE_LABELS', () => {
  test('lists exactly the 9 orchestra/choir labels, in LESSON_TYPE_OPTIONS order', () => {
...
describe('THEORY_LABELS', () => {
  test('lists exactly the 5 theory labels, in LESSON_TYPE_OPTIONS order', () => {
