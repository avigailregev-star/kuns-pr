...
// melodies_group is the legacy attendance-group type for one-student melodies lessons.
export const PRIVATE_TYPES = ['individual_45', 'individual_60', 'melodies_individual', 'melodies_group'];
